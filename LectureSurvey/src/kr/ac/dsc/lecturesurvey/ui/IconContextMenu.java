 ...
 */
package kr.ac.dsc.lecturesurvey.ui;
...
public class IconContextMenu implements DialogInterface.OnCancelListener, 
	 ...
	 * @return
	 */
	public Dialog createMenu(String menuItitle, int icon_resId) {
		final AlertDialog.Builder builder = new AlertDialog.Builder(parentActivity);
        builder.setTitle(menuItitle);
        if(icon_resId != 0)	builder.setIcon(icon_resId);
    ...
    protected class IconMenuAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
	        	...
	        	temp.setPadding((int)toPixel(res, 15), (int)toPixel(res, 15), (int)toPixel(res, 15), (int)toPixel(res, 15));
